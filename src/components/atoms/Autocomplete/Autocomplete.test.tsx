...
describe('Autocomplete', () => {
   ...
   it("restore item text inside input after click outside autocomplete when item was selected", () => {
   ...
   it("open suggestion menu on input focus when input length is not satisfied", () => {
      const { input, label, getSuggestionsMenu } = setup()
   ...
   it("pass correct object on item click", () => {
   ...
   it("highlight suggestions correctly when pressing up and down arrow keys", () => {
      const onSuggestionArrowDown = jest.fn();
      const onSuggestionArrowUp = jest.fn();
      const { input, getSuggestionsItems, getSuggestionsMenu } = setup({ onSuggestionArrowDown, onSuggestionArrowUp })
   ...
   it("does not filter suggestions on type with custom filterSuggestions function", () => {
